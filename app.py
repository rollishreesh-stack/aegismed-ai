...
# Completely normal, un-highlighted copyright footer
COPYRIGHT_FOOTER = """
...
<body class="min-h-screen flex flex-col relative">
    ...
    <main class="flex-1 max-w-[1800px] mx-auto w-full p-6 flex flex-col lg:flex-row gap-8 relative z-10 h-full">
        ...
        <div class="w-full lg:w-[450px] xl:w-[500px] flex flex-col gap-6 shrink-0">
            ...
            <div class="glass-panel rounded-2xl p-5 border-t-2 border-t-cyan-500">
                ...
                <select id="preset-dropdown" onchange="if(this.value) loadPreset(this.value);" class="w-full glass-input px-3 py-3 rounded-lg text-sm font-semibold text-slate-200 cursor-pointer">
                    <option value="" disabled selected>-- Select a Clinical Pathology --</option>
        ...
        <div class="flex-1 flex flex-col gap-6 w-full min-w-0">
            ...
            <div class="glass-panel rounded-3xl flex-1 flex flex-col items-center justify-center min-h-[600px] border-dashed border-slate-600/50">
                ...
                <p class="text-sm text-slate-400 font-mono">Select a pathology profile from the left dropdown matrix.</p>
            </div>
            {% else %}
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                <div class="glass-panel p-8 rounded-2xl border-l-4 border-l-cyan-400 bg-gradient-to-br from-slate-900/95 to-black">
                    ...
                    <div class="text-3xl font-black text-white leading-tight tracking-tight mb-5 uppercase drop-shadow-md">{{ sim_data.ai_condition }}</div>
                    
                    <div class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2 border-b border-white/10 pb-1">Physiological Breakdown</div>
                    <div class="text-sm text-slate-300 bg-black/40 p-4 rounded-lg border border-white/5 leading-relaxed mb-5 shadow-inner">
                        {{ sim_data.ai_description }}
                    </div>

                    <div class="text-[10px] font-bold text-emerald-400 uppercase tracking-widest mb-2 border-b border-white/10 pb-1">Required Clinical Action Plan</div>
                    <ul class="space-y-2">
                ...
                <div class="flex flex-col gap-6">
                    <div class="glass-panel p-8 rounded-2xl border-t-4 border-t-purple-500 flex-1 flex flex-col justify-center">
                        <h3 class="text-[11px] text-purple-400 font-black uppercase tracking-[0.2em] mb-6 text-center">Arterial Blood Gas Analysis</h3>
                        <div class="grid grid-cols-3 gap-2 mb-6 bg-black/40 p-6 rounded-2xl border border-white/5 text-center shadow-inner">
                            <div>
                                <span class="text-[10px] text-slate-500 font-bold uppercase block mb-2">Blood pH</span>
                            ...
                            <div class="border-l border-white/10">
                                <span class="text-[10px] text-slate-500 font-bold uppercase block mb-2">PaCO2</span>
                                <span class="text-3xl font-black font-mono text-amber-400">{{ sim_data.paco2 }}</span>
                            </div>
                            <div class="border-l border-white/10">
                                <span class="text-[10px] text-slate-500 font-bold uppercase block mb-2">HCO3</span>
            ...
            <div class="glass-panel p-6 rounded-2xl">
                <h3 class="text-[11px] text-slate-400 font-black uppercase tracking-[0.2em] mb-4 border-b border-white/10 pb-2">Pulmonary Mechanics Explained</h3>
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <div class="bg-black/40 p-5 rounded-xl text-center border border-white/5 shadow-inner">
                        ...
                        <div class="text-[10px] text-slate-400 leading-snug border-t border-white/10 pt-2">Measures Lung Elasticity. Normal is ~60-80. Lower numbers indicate stiffer, sicker lungs (ARDS).</div>
                    </div>
                    <div class="bg-black/40 p-5 rounded-xl text-center border border-white/5 shadow-inner">
                        ...
                        <div class="text-[10px] text-slate-400 leading-snug border-t border-white/10 pt-2">Measures Airway Blockage. Normal is ~5-10. Higher numbers indicate bronchospasm (Asthma).</div>
                    </div>
                    <div class="bg-black/40 p-5 rounded-xl text-center border border-white/5 shadow-inner">
                        ...
                        <div class="text-[10px] text-slate-400 leading-snug border-t border-white/10 pt-2">Wasted ventilation not participating in gas exchange. Severely high in Pulmonary Embolisms.</div>
                    </div>
                    <div class="bg-black/40 p-5 rounded-xl text-center border border-white/5 shadow-inner">
                        ...
                        <div class="text-[9px] text-slate-500 uppercase font-bold mb-3">Percentage</div>
                        <div class="text-[10px] text-slate-400 leading-snug border-t border-white/10 pt-2">Blood bypassing ventilated alveoli. High levels cause severe hypoxemia (Edema/Pneumonia).</div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function loadPreset(type) {
            ...
            // Auto submit to generate dashboard instantly
